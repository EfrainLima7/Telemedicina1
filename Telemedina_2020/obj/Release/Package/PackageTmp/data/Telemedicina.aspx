<%@ Page Title="Telemdicina" Language="C#" MasterPageFile="~/pricipal.Master" AutoEventWireup="true" CodeBehind="Telemedicina.aspx.cs" Inherits="telemedicina.data.Telemedicina" %>
                ...
                <form method="post" runat="server">
                    <div class="slide-item">
                        <div class="inner-box text-center">
                            ...
                            <asp:Button Text="Empezar" CssClass="btn btn-style-one" runat="server" OnClick="Unnamed1_Click" />
                        </div>
                    </div>
                </form>
            </div>
