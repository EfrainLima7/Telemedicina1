<%@ Page Title="" Language="C#" MasterPageFile="~/pricipal.Master" AutoEventWireup="true" CodeBehind="ConfirmarCita.aspx.cs" Inherits="telemedicina.data.ConfirmarCita" %>
                ...
                <form method="post" runat="server">
                    <div class="slide-item">
                        <div class="inner-box text-center">
                            ...
                            <p><asp:Label ID="descripcion" runat="server" />
                            ...
                            <asp:Button ID="aceptar" CssClass="btn btn-style-one" Text="Continuar" runat="server" OnClick="aceptar_Click" />
